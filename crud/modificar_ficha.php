              ...
              if($resultado->num_rows>0)
              {
                ...
                <form id="formulario2" role="form" method="post" action="actualizar_ficha.php">
                    <div class="col-md-12">
                       ...
                       <input class="form-control" type="number" name="numero" min="9999" max="9999999999" value="<?php echo $fila->ficha_numero ?>" required/>

                       <label class="lgris">Programa:</label>
                       <input class="form-control" type="number" name="prograf" min="1" max="999999999999" value="<?php echo $fila->ficha_progra ?>" required/>
